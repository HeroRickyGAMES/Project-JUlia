...
import com.herorickystudios.jiulia_socialmidia.databinding.FragmentItem3Binding;
 ...
 */
public class MySegudoresRecyclerViewAdapter extends RecyclerView.Adapter<MySegudoresRecyclerViewAdapter.ViewHolder> {

    private final List<PlaceholderItem> mValues;

    public MySegudoresRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
