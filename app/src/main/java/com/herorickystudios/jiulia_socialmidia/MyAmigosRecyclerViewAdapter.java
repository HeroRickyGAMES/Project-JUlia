...
import com.herorickystudios.jiulia_socialmidia.databinding.FragmentItem2Binding;
 ...
 */
public class MyAmigosRecyclerViewAdapter extends RecyclerView.Adapter<MyAmigosRecyclerViewAdapter.ViewHolder> {

    private final List<PlaceholderItem> mValues;

    public MyAmigosRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
